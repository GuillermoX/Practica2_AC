...
enum bpred_class {
  ...
  BPred_NUM,
  BPredAlloy			/* (mod): Alloy branch predictor  */
};
...
struct bpred_dir_t {
  ...
  union {
    ...
    struct {
      ...
      int shift_g_width;		/* (mod): amount of history in global register */
      int xor;			/* history xor address flag */
      int *shiftregs;		/* level-1 history table */
      unsigned char *l2table;	/* level-2 prediction state table */
      int *shiftglob_reg;	/* (mod): Global history register */
    } two;
  } config;
};
...
bpred_create(enum bpred_class class,	/* type of predictor to create */
	     ...
	     unsigned int global_shift_width, /* (mod): global history register width*/
...
bpred_dir_create (
  ...
  unsigned int shift_width,	/* history register width */
  unsigned int globa_shift_width,	/* (mod) global history register width */
  unsigned int xor);	   	/* history xor address flag */
